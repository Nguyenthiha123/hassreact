            ...
            return data.map((el, index) => (
                <Fragment>
                    <tr key={index}>
                        <td>{el.id}</td>
                        <td>
                            {category && category.map(cate => cate.id == el.categoryId && cate.name)}
                        </td>
                        <td>{el.name}</td>
                        <td>
                        ...
                        <td>
                            ...
                            <button type="button" onClick={() => deleteProduct(el.id)} style={{ marginTop: "10px" }} className="btn btn-outline-info">Xóa</button>

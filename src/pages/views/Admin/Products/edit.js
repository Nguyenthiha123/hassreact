...
const EditProducts = props => {
    ...
    const onHandleSubmit = async (data) => {
        const result = await axios.put(`http://localhost:8080/product/${id}`, data);
        console.log(result)
        ...
        <div className="container">
            <form onSubmit={handleSubmit(onHandleSubmit)}>
                ...
                <div className="form-group">
                    ...
                    <select className="form-control" defaultValue={product.categoryId} name="categoryId" ref={register({ required: true })} >

...
const CategoryPost = props => {
        ...
        if (data) {
            return data.map((el, index) => (
                <tr key={index}>
                    ...
                    <td>
                        <Link to={`/admin/categoryPost/edit/${el.id}`} type="button" class="btn btn-outline-info">Sửa</Link>
                        <button style={{ marginLeft: "10px" }} onClick={() => deleteCategoryPost(el.id)} type="button" class="btn btn-outline-info">Xóa</button>
                    </td>
                </tr>
    ...
    return (
        <div className="container">
            ...
            <Link to="/admin/categoryPost/add" type="button" class="btn btn-outline-info" > Thêm</Link>

...
const AddPost = props => {
    ...
    useEffect(() => {
        const getCategoryPost = async () => {
            try {
                const { data } = await axios.get('http://localhost:8080/category_post');
    ...
    const addPost = async (e) => {
        console.log(e)
        const data = await axios.post('http://localhost:8080/post', e);
        console.log(data);
        // debugger
        ...
        <div className="container">
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="form-group">
                    ...
                    <input type="text" ref={register({ required: true, minLength: 3, pattern: /^\S{1}.{0,24}$/i })} name="title" className="form-control" id="exampleInputEmail1" />
                ...
                <div className="form-group">
                    ...
                    <input type="text" ref={register({ required: true, minLength: 3, pattern: /^\S{1}.{0,24}$/i })} name="content" className="form-control" id="exampleInputEmail1" />
                    <small className="form-text text-danger">

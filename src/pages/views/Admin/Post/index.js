...
const Post = props => {
        ...
        if (data) {
            return data.map((el, index) => (
                <tr key={index}>
                    ...
                    <td>
                        <Link to={`/admin/post/edit/${el.id}`} type="button" class="btn btn-outline-info">Sửa</Link>
                        <button style={{ marginLeft: "10px" }} onClick={() => deletePost(el.id)} type="button" class="btn btn-outline-info">Xóa</button>
                    </td>
                </tr>
    ...
    return (
        <div className="container">
            ...
            <Link to="/admin/post/add" type="button" className="btn btn-outline-info" > Thêm</Link>

...
const EditUser = props => {
    ...
    const onHandleSubmit = async (data) => {
        const result = await axios.put(`http://localhost:8080/post/${id}`, data);
        console.log(result)
        ...
        <div className="container">
            <form onSubmit={handleSubmit(onHandleSubmit)}>
                ...
                <div className="form-group">
                    ...
                    <input type="text" ref={register({ required: true, minLength: 3, pattern: /^\S{1}.{0,24}$/i })} defaultValue={post.title} name="title" className="form-control" id="exampleInputEmail1" />
